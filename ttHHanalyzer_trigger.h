...
class ttHHanalyzer {
 public:
	...
	*hInvMassHH2Matched,
    ...
    fifo_map<std::string,int> cutflow{{"count_elec", 0}, {"count_muon", 0},{"noCut", 0}, {"nTrigger", 0}, {"jetPt>30", 0}, {"nFilter", 0}, {"nPV", 0}, {"njets>4", 0}, {"nbjets>3", 0}, {"nlepton==2", 0}, {"nOpositeChargedLep", 0}, {"nMassCut", 0}, {"nTotal", 0}, {"MET>40", 0}};
    fifo_map<std::string,int> cutflow_w{{"count_elec", 0}, {"count_muon", 0},{"noCut", 0}, {"jetPt>30", 0},{"njets>4", 0}, {"nbjets>4", 0}, {"nlepton==2", 0}, {"nOpositeChargedLep", 0}, {"nMassCut", 0}, {"nTotal", 0}, {"MET>40", 0}};
...
//    std::string _sample;
	...
	hmet = new TH1F("met"+trail, "MET"+trail, 50, 0, 1500);
